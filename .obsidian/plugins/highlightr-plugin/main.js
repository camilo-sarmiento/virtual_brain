...
class HighlightrSettingTab extends obsidian.PluginSettingTab {
    ...
    display() {
        ...
        const styleDemo = () => {
            ...
            d.innerHTML = `
      <span style="background:#FFB7EACC;padding: .12em .125em;--lowlight-background: var(--background-primary);border-radius: 0;background-image: linear-gradient(360deg,rgba(255, 255, 255, 0) 40%,var(--lowlight-background) 40%) !important;">Lowlight</span> 
